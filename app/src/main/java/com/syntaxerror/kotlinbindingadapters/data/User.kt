package com.syntaxerror.kotlinbindingadapters.data
...
data class User(val userName:String,val email:String,val mobile:String,val city: String,val url:String)
